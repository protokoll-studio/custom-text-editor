                ...
                return function (n, e) {
                    ...
                    return a < 0 || a >= f
                        ? t
                            ? ""
                            : void 0
                        : (o = c.charCodeAt(a)) < 55296 || o > 56319 || a + 1 === f || (u = c.charCodeAt(a + 1)) < 56320 || u > 57343
                        ? t
                            ? c.charAt(a)
                            : o
                        : t
        ...
        function (t, n, e) {
            ...
            t.exports = function (t, n, e, v, d, y, m) {
                ...
                if (
                    ...
                    if (((g = { values: O ? T : b("values"), keys: y ? T : b("keys"), entries: P }), m)) for (_ in g) _ in S || o(S, _, g[_]);
                ...
                "Array",
                {
                    from: function (t) {
                        var n,
                            ...
                            m = 0,
                            g = s(p);
                        if ((y && (d = r(d, v > 2 ? arguments[2] : void 0, 2)), null == g || (h == Array && c(g)))) for (e = new h((n = a(p.length))); n > m; m++) f(e, m, y ? d(p[m], m) : p[m]);
                        else for (l = g.call(p), e = new h(); !(i = l.next()).done; m++) f(e, m, y ? u(l, d, [i.value, m], !0) : i.value);
                        return (e.length = m), e;
                    },
                }
            );
                ...
                f = function (t, n) {
                    return t.reduce(
                        function (t, e) {
                            var r = e.width,
                                i = (r / n) * a;
                            return { j: t.j + i, rotations: t.rotations.concat([t.j + i / 2]) };
                        },
                        { j: 0, rotations: [] }
                    );
                };
            ...
            var l = Math.PI,
                ...
                v = (function () {
                    function t(n, e) {
                        ...
                        o.setAttribute("aria-label", n.innerText),
